...
// KIP ORIGINAL #define BED_MAXTEMP 130
...
// KIP changing this so the nozzle doesn't move beyond the corner cutoffs of my current glass.
// KIP #define MIN_PROBE_EDGE 10
...
// KIP: I had to change the Y belt mount point on the AM8 build so I also had
// to change the inverting setting for Y below.
// KIP #define INVERT_Y_DIR false
...
// :[-1,1]
// KIP: Y_HOME_DIR should be -1 if the Y endstop switch is mounted at the rear,
// so for my AM8 the setting below is correct.
#define X_HOME_DIR -1
#define Y_HOME_DIR -1
#define Z_HOME_DIR -1
